...
class User {
    ...
    // Obtener usuario por email (incluyendo intentos fallidos y bloqueo)
    ...
    // 📌 Reiniciar intentos fallidos al hacer login correcto
    ...
    // 📌 Bloquear usuario hasta cierta fecha/hora
